# Generated by Django 4.2.7 on 2025-10-17 20:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emailFiscContr', models.EmailField(max_length=40, unique=True, verbose_name='E-mail Fiscal-Contratada')),
                ...
                ('contAto', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message='Celular deve estar no formato: (99)99999-9999', regex='^\\(\\d{2}\\)\\d{4,5}-\\d{4}$')], verbose_name='Celular ATO')),
                ...
                ('contSto', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message='Celular deve estar no formato: (99)99999-9999', regex='^\\(\\d{2}\\)\\d{4,5}-\\d{4}$')], verbose_name='Celular STO')),
                ('criado_em', models.DateTimeField(auto_now_add=True)),
                ('atualizado_em', models.DateTimeField(auto_now=True)),
